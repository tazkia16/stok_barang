...
<nav id="sidebar">
    <div class="p-4 pt-5">
        <a href="<?= site_url(); ?>" class="img logo rounded-circle mb-3" style="background-image: url(<?= base_url('assets/img/logo.jpg'); ?>); transform: scale(1.2);"></a>
        ...
        <div class="footer">
            <p>
                ...
                </script> All rights reserved | This project is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://www.instagram.com/tzaaa69?igsh=emZyeDludTJxamF1" target="_blank">Tazkia Aulia (11211476)</a>
