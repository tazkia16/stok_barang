...
class M_barang extends CI_Model
{
    ...
    var $column_order    =  array(null, 'kode_barang', 'nama_barang', 'brand', 'stok', 'hargal', 'active', null); //set column field database 
    var $column_search   =  array('kode_barang', 'nama_barang', 'brand', 'stok', 'harga', 'active'); //set column field database untuk datatable 
